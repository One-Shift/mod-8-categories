INSERT INTO `{{ prefix }}_modules` (`name`, `folder`, `code`, `icon`, `img`, `dropdown`, `sidebar`) VALUES ('{{ mod-name }}', '{{ mod-folder }}', '{"fa-icon": "fa-list","img": "","sub-items": {"List": {"url": ""},"Add category": {"url": "add"}},"sidebar": true,"dropdown": false}', 'fa-list', '', 0, 1);
