		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input list="category-type" name="category-type" class="bo3-form-control form-control" type="text" placeholder="{{ select-option-type }}" id="inputType" value="{{ type-value }}" required>
				...
				<div class="form-group">
					...
					<select name="category-parent" id="inputParent" class="bo3-form-control form-control">
						<option value="-1" disabled>{{ select-option-parent }}</option>
						<option value="-1" {{ selected }}>{{ select-option-parent-no }}</option>
						{{ parent-options }}
					</select>
				</div>
				<!-- END Category Parent -->
				...
				<div class="form-group">
					...
					<input name="sort" id="inputSort" type="number" class="bo3-form-control form-control" placeholder="{{ sort-placeholder }}" value="{{ sort-value }}" required>
				</div>
				<!-- END Category Sort -->
				<div class="spacer all-15"></div>
				<!-- Category Code -->
				<div class="form-group">
					...
					<textarea name="code" id="inputCode" class="bo3-form-control form-control" rows="1"  placeholder="{{ code-placeholder }}" style="resize: vertical;">{{ code-value }}</textarea>
				</div>
				<!-- END Category Code -->
				<div class="spacer all-15"></div>
				<!-- Category Published -->
